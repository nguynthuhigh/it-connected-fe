  ...
  return (
    <tr key={props.key} className="w-full text-sm border-t">
      ...
      <td className="p-2 text-[#25FF3B]">
        <span
          className={`px-2 py-1 border rounded-full font-semibold ${
            person.status
              ? "border-[#25FF3B]"
              : "text-[#FF2525] border-[#FF2525]"
          }`}
        >
      ...
      <td className="p-2">
        <span className="px-2.5 py-1 border text-[#123288] border-[#123288] rounded-full">
          View more
        </span>
      </td>
    </tr>
