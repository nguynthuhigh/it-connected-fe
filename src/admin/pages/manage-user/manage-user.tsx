        ...
        <div className="flex w-full font-inter">
            <div className="p-5 w-[15%]">
                ...
                <div className='px-2 py-1 justify-center flex'>
                    <button className="border px-5 py-2 text-center text-white rounded-full bg-blue-500 font-medium text-[20px] hover:border-blue-500 hover:text-blue-600 hover:bg-white">Manage Users</button>
                </div>
            </div>
            <div className="py-5 px-10 w-full">
                <div className="flex justify-between ">
                    ...
                    <div className="flex gap-5 items-center">
                        <div className='border p-2 rounded-full'><img src={iconSetting} alt="Notification Icon" /></div>
                        <div className='border p-2 rounded-full'><img src={iconNotification} alt="Notification Icon" /></div>
                        <div className='border rounded-full'><img src="https://i.imgur.com/xmOk59x.png" alt="" /></div>
                    </div>
                </div>
                <hr />
                <div className="p-5 ">
                ...
                <div className=' flex justify-end pr-[100px] mt-2'> 
                    <div className='flex gap-5 items-center'>
                        <button className='flex gap-3 items-center'><img className='' src={iconPrevious} alt="buttonPrevious" /><span>Previous</span></button>
                        <div className='flex'>
                            <button className='border bg-black text-white px-4 py-2 rounded-xl'>1</button>
                            <button className='bg-white text-black px-4 py-2 rounded-xl'>2</button>
                            <button className='bg-white text-black px-4 py-2 rounded-xl'>3</button>
                            <button className='bg-white text-black px-4 py-2 rounded-xl'>4</button>
                        </div>
                        <button className='flex gap-3 items-center'><span>Next</span><img src={iconNext} alt="buttonNext" /></button>
                    </div>
                </div>
            </div>
        </div>
