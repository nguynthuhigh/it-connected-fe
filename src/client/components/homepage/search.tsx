...
const Search = () => {
    return (
        <div className='bg-[#A6CCF8]'>
            <div className='bg-[#A6CCF8] max-w-[1200px] mx-auto px-5'>
                <h1 className='text-[24px] sm:text-[29px] text-white font-semibold pb-8 pt-14'>
                    999 Việc làm IT cho Developer "Chất"
                </h1>
                <div className='flex flex-col sm:flex-row pb-6 max-w-[1400px] gap-2'>
                    <button className="flex bg-white w-full sm:w-1/5 border rounded-md border-[#DEDEDE] justify-between items-center gap-2 py-4 px-5">
                    ...
                    <div className="border border-[#DEDEDE] rounded-md w-full sm:w-3/5">
                        <input 
                            className="rounded-md w-full h-full p-4 focus:outline-none" 
                            type="text" 
                            placeholder="Nhập từ khoá theo kỹ năng, chức vụ, công ty..." 
                        />
                    </div>
                    <button className='bg-[#ed1b2f] flex w-full sm:w-1/5 rounded-md items-center gap-2 justify-center py-4'>
                        <img className="w-[20px]" src={IconSearch1} alt="icon search" />
                        <span className="text-white text-[18px]">Tìm kiếm</span>
                    </button>
                </div>
                <div className='flex flex-col sm:flex-row gap-4 pb-10 text-white items-center'>
