    ...
    <div className='min-h-screen flex justify-center items-start mt-40'>
        ...
        <div className='mt-3'>
          ...
          <div className='mt-3  flex items-center justify-center'>
            <button className=' text-white rounded-lg bg-blue-main w-full h-11 text-lg font-inter'>Sign In</button>
          </div>
      <div className="text-center mt-3">
        <p className="text-base text-gray-600 font-inter">
          Do not have an account? <a href="/register" className="text-blue-main font-inter font-semibold">Sign up</a>
        </p>
      </div>
