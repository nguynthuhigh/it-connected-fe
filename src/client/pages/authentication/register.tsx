    ...
    <div className='min-h-screen flex justify-center items-start pt-12'>
        ...
        <div>
          ...
          <div className='mt-3  flex items-center justify-center'>
            <button className=' font-bold text-white rounded-md bg-btn-login w-full h-11 text-xl'>Sign Up</button>
          </div>
          <div className="text-center mt-4">
          <p>Already have an account? <a href="/login"  className=" text-forgotten hover:underline">Sign in now!</a>
          </p>
        </div>
