const RegisterForm = () => {
    return (
      <div className="max-w-4xl mx-auto bg-white p-10 shadow-md rounded-lg mt-10">
        ...
        <form className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="w-full h-36 bg-gray-200"> {/* Map placeholder */}</div>
            </div>
          </div>
